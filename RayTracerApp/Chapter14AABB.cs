...
{
    public class Chapter14AABB
    {
        public Chapter14AABB()
        {
            var floor = new Plane();
            ...
            canvas.WriteImageFile("I:\\Programming\\DotNetCore\\RayTracer\\RayTracer\\Images\\chapter14AABB");
            Console.WriteLine("Chapter14AABB Complete");
        }
